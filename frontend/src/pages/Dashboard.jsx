...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <p className="page-sub">Your job hunt, run by Electronic. Connect your tools, scout roles, and let the agent apply — you approve every step.</p>
      <div className="banner">
        👋 This is v0.1. <b>Electronic chat runs on real Qwen</b> via your DigitalOcean key. LinkedIn scouting and the ATS Apply-Driver are wired as previews and will go live next.
      </div>
      <div className="cards">
        ...
        <div className="card"><h3>🪽 Electronic {status(c?.hermes?.connected)}</h3><p>The job-search agent. <Link to="/hermes">Open chat →</Link></p></div>
        <div className="card"><h3>💬 Telegram {status(c?.telegram?.connected)}</h3><p>Talk to Electronic from your phone. <Link to="/connections">Connect →</Link></p></div>
