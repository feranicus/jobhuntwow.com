...
export default function Electronic() {
  ...
  const [msgs, setMsgs] = useState([{ role: "assistant", content: "Hi, I'm Electronic. Tell me what roles you want and I'll get to work. What are you looking for?" }]);
  ...
  return (
    <>
      <h1 className="page-h">Electronic {model ? <span className="tag">{model}</span> : null}</h1>
      ...
      <div className="chat">
        ...
        <div className="chat-input">
          <input className="input" placeholder="Message Electronic…" value={input}
